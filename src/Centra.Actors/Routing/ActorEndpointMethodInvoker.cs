...
namespace Centra.Actors.Routing;

public sealed class ActorEndpointMethodInvoker
{
    ...
    public ActorEndpointMethodInvoker(Func<object, ReadOnlyMemory<byte>, CancellationToken, ValueTask<object?>> invoker)
    {
        _invoker = invoker;
    }
    ...
    public static ActorEndpointMethodInvoker? Create(Type actorType, string methodName)
    {
